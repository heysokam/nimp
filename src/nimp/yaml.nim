...
type YamlCfg = object
  tags     :TagStyle
  handles  :seq[tuple[handle, uriPrefix: str]]
  anchor   :AnchorStyle
...
#______________________________
proc writeYaml *[T](value :T; file :str) :void {.raises: [YamlPresenterJsonError, YamlPresenterOutputError, YamlSerializationError, Exception].}=
